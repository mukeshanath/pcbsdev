...
date_default_timezone_set('Asia/Kolkata');
    ...
    if(isset($_POST['cno']))
    {
        ...
        $staff_code         = $_POST['staff_code'];
            ...
            $db->query("INSERT INTO opdatabatch with (rowlock) (cno,tdate,origin,destn,wt,mode_code,wayno,ttype,type,comp_code,br_code,rcode,staff_code,date_added) VALUES ('$cno','$tdate','$origin','$destn','$wt','$mode_code','$wayno','$ttype','$type','$comp_code','$br_code','$rcode','$staff_code',getdate())");
