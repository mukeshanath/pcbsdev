...
<!-- Bread Crumb -->
                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <a href="<?php echo __ROOT__ . 'perfomancereport'; ?>">Performance Report Filters</a>
                                      </li>
                                        </ul>
                                    </div>
 ...
 <div class="boxed boxBt panel panel-primary">
                    <!-- Tittle -->
    <div class="title_1 panel-heading"><p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Perfomance Report</p>
   ...
   <input type="text" id="stncode" class="hidden" name="inv_stn" value="<?=$stationcode;?>">
    ...
    <div class="tab-content">
     ...
     <table cellpadding="0" border="0" cellspacing="0" class="table" style="width:100%">
	   <tr><td class="filter-title">Report Name</td></tr>
        <tr>		
            ...
            <option value="weightdeviation">Weight Deviation Report</option>     -->     
            <option value="billedvalue">Billed Value Deviation Report</option>    
     ...
     <table cellpadding="0" border="0" cellspacing="0" class="table" style="width:100%">
	   <tr><td class="filter-title" colspan="3">Invoice Month Range</td><td class="filter-title">Year</td></tr>
        <tr>		
     ...
     <div class="report-header" style="border-bottom:2px solid black;margin-bottom:10px">
          <div class="date-between-column" style="text-align:left;">
               <h5 class="preview-heading">Preview of Perfomance Summary between <span id="head-date-from"></span> and <span id="head-date-to"></span></h5>
          </div>
     </div>
...
<script>
     $('#filter-next').click(function(){
          ...
          $.ajax({
            ...
            method:"POST",
            data:{dev_reporttype,dev_date_from,dev_date_to},
            dataType:"text",
            success:function(data)
            {
            $('.invoice-report-table').html(data);
          //   if(reporttype=='invoicesummary'){
            $('.preview-heading').html('Deviation Summary Between '+dev_date_from+' and '+dev_date_to);
