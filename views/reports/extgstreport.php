                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <a href="<?php echo __ROOT__ . 'extgstreport'; ?>">GST Report Filters</a>
                                      </li>
                                        </ul>
                                    </div>
 ...
 <div class="boxed boxBt panel panel-primary">
   ...
   <input type="text" id="gst_stn" class="hidden" name="gst_stn" value="<?=$stationcode;?>">
    ...
    <div class="tab-content">
     ...
     <button type="button" class="btn btn-success" data-toggle="tab" id="filter-next" _onclick="generatereport()">
              Generate Report
               </button>
     </div>
     </div>
...
<script>
     $('#filter-next').click(function(){
          ...
          var gst_branch = '<?=$datafetch['br_code']?>';
          var gst_customer = '<?=$datafetch['cust_code']?>';
          if(gst_branch.trim()=='' || gst_customer.trim()==''){
                swal("There is No branch and Customer is assigned");
            }
            else{
                progress();  
                generatereport();
