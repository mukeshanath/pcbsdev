...
if(isset($_GET['grp_id'])){
    ...
    $invoicedelete          =  $db->query("SELECT module FROM users_group WHERE group_name='$group_name' AND module='invoicedetail'");
    ...
    $collectiondelete         =  $db->query("SELECT module FROM users_group WHERE group_name='$group_name' AND module='collectionlist'");
        ...
        <div class="content panel-body">
          ...
          <input type="text" name="usergroup" id="usergroup" style="display:none" value="<?=$_GET['grp_id']; ?>">
            ...
            <tbody>
                     ...
                     <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" <?php if($duplicatechalllan->rowCount()==0){ echo ''; }else{ echo 'Checked'; } ?> value="duplicatechellan1,p_create"></td>
                     <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" disabled></td>
                     <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" <?php if( $duplicatechalllan->rowCount()==0){ echo ''; }else{ echo 'Checked'; } ?> value="duplicatechellan1,list_access"></td>
                     <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" disabled></td>
                     ...
                     <tr>
                         ...
                         <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" <?php if($demoreport->rowCount()==0){ echo ''; }else{ echo 'Checked'; } ?> value="demoreport,p_create"></td>
                         <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" disabled value="invoiceedit,p_modify"></td>
                         <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" disabled value="invoicelist,list_access"></td>
                         <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" disabled value="invoicedetail,detail_access"></td>
                         <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" disabled value="invoicedelete,remove"></td>
                    ...
                    <tr>
                         ...
                         <td class="text-center"><input style='width:120px;height:25px;' type="checkbox" name="module[]" disabled value="exbainboundreportedit,p_modify"></td>
