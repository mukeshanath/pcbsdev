         ...
         <div class="alert-primary" role="alert">
            ...
            <div class="boxed boxBt panel panel-primary">
              <div class="title_1 title panel-heading">
                    <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">User Group Filters</p>
                    <div class="align-right" style="margin-top:-35px;">

        

                    <a style="color:white" href="<?php echo __ROOT__ ?>usergroup"><button type="button" class="btn btn-success btnattr" >
          ...
          <table class="table" cellspacing="0" cellpadding="0" align="center">	
            <tbody>
              <tr>		
                  ...
                  <td>
                  <div class="col-sm-9">
                      <input placeholder="" class="form-control border-form" name="addr_type" type="text" id="addr_type" >
                    </div>
                      </td>
                  ...
                  <td>
                  <div class="col-sm-9">
                      <input placeholder="" class="form-control border-form today" name="addr_type" type="date" id="addr_type" >
                    </div>
                      </td>
                ...
                <div class="col-sm-12 data-table-div" >
                 ...
                 <div class="title_1 title panel-heading">
              <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Users Group List</p>
                         ...
                         while ($row = $query->fetch(PDO::FETCH_OBJ))
                          {
                            ...
                            <a class='btn btn-success btn-minier' href='usergroupedit?grp_id=".$row->group_name."' data-rel='tooltip' title='Edit'>
                            <i class='ace-icon fa fa-pencil bigger-130'></i>
                           </a>
                                 <a class='btn btn-primary  btn-minier' href='usergroupdetail?grp_id=".$row->group_name."' data-rel='tooltip' title='Edit'>
                                  <i class='ace-icon fa fa-eye bigger-130'></i>
                                 </a>

                                 <a  class='btn btn-danger btn-minier bootbox-confirm' id='users_group,$row->group_name' onclick='".delete($db,$user)."'>
   ...
   var usr_name = $('#user_name').val();    
        $.ajax({
            ...
            if($('#stncode').val() == '')
              {
                //alert(data[0]);
                $('#useradd').attr('href','<?php echo __ROOT__ ?>userform');
              }
              else {
...
.then((willDelete) => {
  if (willDelete) {
    ...
    var deleteuuser = $('#user_name').val();

    $.ajax({
              url:"<?php echo __ROOT__ ?>peoplecontroller",
              method:"POST",
              data:{deletetb:deletetb,deleterow:deleterow,deleteuuser},
              dataType:"text",
              success:function(value)
              {
                location.reload();
