         ...
         <div class="alert-primary" role="alert">
            ...
            <div class="boxed boxBt panel panel-primary">
              <div class="title_1 title panel-heading">
                    <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Credit Bulk Upload Filters</p>
                    <div class="align-right" style="margin-top:-35px;">

         <a style="color:white" href="<?php echo __ROOT__ ?>creditbulkupload"><button type="button" class="btn btn-success btnattr" >
            ...
            <tbody>
              <tr>		
                ...
                <div class="col-sm-12 data-table-div" >
                 ...
                 <div class="title_1 title panel-heading">
              <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Credit Bulk Upload List</p>
        ...
        <thead><tr class="form_cat_head">
             <th class="center">
              ...
              <tbody>
               ...
               $row = $db->query("SELECT DISTINCT date_added,comp_code FROM credit WHERE import='1'");
               while($value = $row->fetch(PDO::FETCH_OBJ)){
                    $count = $db->query("SELECT count(*) AS 'counts' FROM credit WHERE date_added='$value->date_added' AND import=1")->fetch(PDO::FETCH_OBJ);
                    echo "<tr>
                          ...
                          <td><div class='hidden-sm hidden-xs action-buttons'>
                                 ...
                                 <a class='btn btn-primary  btn-minier' href='creditcnotedetail?import=$value->date_added' data-rel='tooltip' title='Edit'>
