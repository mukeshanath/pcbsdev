...
<div class="au-breadcrumb m-t-75" style="margin-top:6px!important;">
            ...
            <form method="POST" action="<?php echo __ROOT__ ?>cashbulkupload" autocomplete="off" accept-charset="UTF-8" class="form-horizontal" id="formitem" enctype="multipart/form-data">
            ...
            <div class="title_1 title panel-heading">
                  <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Cash Bulk Upload</p>
                  <div class="align-right" style="margin-top:-30px;">
            
           

            <a style="color:white" href="<?php echo __ROOT__ . 'cashbulkuploadlist'; ?>">         
        ...
        <tr>		
			...
			<td>
                <div class="autocomplete col-sm-12">
				    <input type="date" class="form-control input-sm today" name="edate" id="edate" onkeyup="fetchvendor()"> 
                </div>
			</td>	
            </tr>
            <tr>
            ...
            <div class="autocomplete col-sm-12">
               ...
               <td></td>
               <td></td>
               <td>	<button type="submit" class="btn btn-primary btnattr_cmn" id="cashbulkupload" name="cashbulkupload">
