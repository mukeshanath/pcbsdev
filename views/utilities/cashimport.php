...
<div class="au-breadcrumb m-t-75" style="margin-top:6px!important;">
            ...
            <form method="POST" action="<?php echo __ROOT__ ?>cashimport" enctype="multipart/form-data">

            <input placeholder="" class="form-control border-form" name="user_name" type="text" id="user_name" value="<?php echo $_SESSION['user_name']; ?>" style="display:none;">    

	        <div class="boxed boxBt panel panel-primary">
            <div class="title_1 title panel-heading">
                  <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Cash Import</p>
                  <div class="align-right" style="margin-top:-30px;">
            
           

            <a style="color:white" href="<?php echo __ROOT__ . 'cashimportlist'; ?>">         
        ...
        <tr>		
			<td>Company Code</td>
			<td>
            <input id="comp_code" name="comp_code" type="text" value="" class="form-control input-sm" readonly>
            </td>
            ...
            <div class="autocomplete col-sm-12">
                ...
                <input type="file" class="form-control input-sm" name="importfile" id="importfile" required  onchange="ValidateSingleInput(this);"  accept=".csv"> 
               ...
               <td></td>
               <td></td>
               <td>	<button type="button" class="btn btn-primary btnattr_cmn" id="import" name="import">
...
$('#import').click(function(){
    ...
    console.log('req',importfile);
    if(importfile)
    {
        $(this).html("<i class='fa fa-spinner'></i>&nbsp; Import");
     ...
     //console.log(fd);
        $.ajax({
            url:"<?php echo __ROOT__ ?>utilitiescontroller",
            method:"POST",
            processData: false,
            contentType: false,
            data:fd,
            ...
            //     if(res.success==true){
            //         $('#import').html("<i class='fa fa-spinner'></i>&nbsp; Import");
            //         console.log('success initiated');
            //         location.href='cashimportlist?success=1'
            //     }
            //     else{
            //         $('#import').html("<i class='fa fa-download'></i>&nbsp; Import");

            //         swal("Data Not Updated!", "Please Check Excel format!", "error");
            //     }
            // }
    });
