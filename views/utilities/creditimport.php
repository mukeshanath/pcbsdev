...
<div class="au-breadcrumb m-t-75" style="margin-top:6px!important;">
            ...
            <a style="color:white" href="<?php echo __ROOT__ . 'creditimportlist'; ?>">         
        ...
        <tr>		
			...
			<td>Import File</td>
			<td>
            <form method="POST" action="<?php echo __ROOT__ ?>creditimport" enctype="multipart/form-data">
            <input placeholder="" class="form-control border-form" name="user_name" type="text" id="user_name" value="<?php echo $_SESSION['user_name']; ?>" style="display:none;"> 
            <div class="autocomplete col-sm-12">
                
                <input type="file" class="form-control input-sm" name="importfile" id="importfile" required accept=".xlsx,.csv,.xls"  onchange="ValidateSingleInput(this);"> 
               ...
               <td></td>
               <td></td>
               <td>	<button type="submit" class="btn btn-primary btnattr_cmn" id="import" name="import">
