...
<div id="col-form1" class="col_form lngPage col-sm-25">
      ...
      <form method="POST" autocomplete="off" action="<?php echo __ROOT__ ?>creditnoteedit" accept-charset="UTF-8" class="form-horizontal" id="formcustomerrate" enctype="multipart/form-data">
       ...
       <div class="title_1 title panel-heading">
        ...
        <tr>
            ...
            <td> <div class="autocomplete col-sm-12">
                <input class="form-control border-form "  name="cust_name" type="text" id="cust_name" value="" value="<?=$fetchcustomer->cust_name?>" readonly></div>
            </td>
        ...
        <td>Invoice Date</td>
        <td>
            <input placeholder="" class="form-control today" name="invdate" type="date"  id="invdate" value="<?=$crn_data->invdate?>" readonly>
        </td>
        ...
        <td>Balance</td>
        <td>
            <input placeholder="" class="form-control " name="balamt" type="text"  id="balamt">
        </td>
        ...
        <td style="width: 29.3%;">
            <input  class="form-control " name="totamt" type="text"  id="totamt"  value="<?=$crn_data->net_amt?>"/>
        </td>
          ...
          <select class="form-control" name="remarks">
            ...
            <table class="table">
              ...
              <div class="align-right btnstyle" >
                  <button type="button" class="btn btn-primary btnattr_cmn" id="updatecreditnote" name="updatecreditnote" onclick="verify()">
...
<script>
 function verify()
    {
        if($('#lockstatus').val().trim()=='Locked')
        {
            alert("This Customer credit note is temporarily locked due to pending invoices");
        }
        else{
            $('#updatecreditnote').attr('type','submit');
            $('#updatecreditnote').attr('name','updatecreditnote');
        }
    }
</script>
<script>
