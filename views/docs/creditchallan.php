     ...
     <div class="main-box" _style="background:<?=$challanbg[$i]?>">
          ...
          <div class="right">
               ...
               <div class="receiver-address" style="text-align:center">
                    AIRWAY BILL NO      <br>
                    <img style="width:180px;margin-bottom:5px;" src="barcode?text=<?=$stationcode.$cashcno->cno?>&codetype=code128&orientation=horizontal&size=40&print=<?=$stationcode.$cashcno->cno?>" class="barcode">
                    <h1 style="color:black;margin-top:0%;"><?=$stationcode.$cashcno->cno?><?=($decoded_type=='reprinted'?' (Duplicate)':'')?></h1>
