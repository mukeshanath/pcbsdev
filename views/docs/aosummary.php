...
if(isset($_GET['sonumber'])){
     ...
     $rowso = $db->query("SELECT * FROM cnoteallocationcc WHERE salesorderid='$sonumber'")->fetch(PDO::FETCH_OBJ);
     $rows_o = $db->query("SELECT * FROM cnoteallocationccdetail WHERE salesorderid='$sonumber'")->fetch(PDO::FETCH_OBJ);
     $rowcompany = $db->query("SELECT * FROM station WHERE stncode='$rowso->stncode'")->fetch(PDO::FETCH_OBJ);
     $rowcustomer = $db->query("SELECT * FROM collectioncenter WHERE stncode='$rowso->stncode' AND cc_code='$rowso->cc_code'")->fetch(PDO::FETCH_OBJ);
}
?>
    <header>
    ...
    <div id="company" class="clearfix">
      ...
      <div id="project">
        ...
        <div class="customerbox"><div><?=$rowcustomer->cc_name;?></div>
        <div><?=$rowcustomer->cc_addr;?></div>
        <div><?=$rowcustomer->cc_city;?></div>
        <div><?=$rowcustomer->cc_state;?></div>
        <div><p style="vertical-align: text-bottom;">Mobile : <?=$rowcustomer->cc_mobile;?></p></div>
        <div><p style="vertical-align: text-bottom;"><strong>Email : </strong><?=$rowcustomer->cc_email;?></p></div>
        <div><p style="vertical-align: text-bottom;"><strong>GSTIN : </strong><?=$rowcustomer->cc_gstin;?></p></div>
        </div>
     </div>
      </div>
    </header>
    <section>
      ...
      <table class="cnotestable">
        ...
        <tbody class="tablebody">
             <!-- <tr> -->
          <?php
                    $sod = $db->query("SELECT * FROM cnoteallocationccdetail WHERE salesorderid='$sonumber'");  $i=0; 
                    ...
                    echo "<td class='centertb'>".$rowcustomer->cnote_charges."</td>";
                    echo "<td class='centertb'>".$rowsod->cnote_count*$rowcustomer->cnote_charges."</td>";
                 ...
                 //check gst of customer for seperate igst,cgst,sgst
                    ...
                    <td  colspan="1"></td><td></td>
                    <td class='righttb'><?=number_format($rows_o->tranship_charge,2)?></td>
                    </tr>
