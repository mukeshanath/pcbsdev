...
for($i=0;$i<count($challan_bottom);$i++){
     ...
     //get cnote details
     $cashcno = $db->query("SELECT TOP 1 *, FORMAT(date_added, 'yyyy/MM/dd HH:mm') AS time FROM credit  WHERE cno='$cno' AND comp_code='$stationcode' AND cust_code='$custcode'")->fetch(PDO::FETCH_OBJ);
