...
?>
    ...
    <div id="company" class="clearfix">
      ...
      <div id="project">
       <div> DATE  :  <?=$mfmaster->date_added;?></div>
      ...
      <table>
        ...
        <tbody class="tablebody">
          <?php
                    ...
                    echo "<td class='centertb'>".number_format($rowpod->wt,3)."</td>";
                    echo "<td class='centertb'>".$rowpod->mode_code."</td>";
                    echo "<td class='centertb'>".$rowpod->dest_code."</td>";
                    echo "<td class='centertb'>".round($rowpod->amt)."</td>";
                    if($i % 2 == 0){
                         echo "</tr>";   
                         }
                    }                                  
