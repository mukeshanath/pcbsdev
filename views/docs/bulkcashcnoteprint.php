...
$challan_bottom = array("CONSIGNOR COPY","PROOF OF DELIVERY"); // accounts copy removed by cr PT-227 jira list -- ,"ACCOUNTS COPY"
...
if($challan_bottom[$i]=="CONSIGNOR COPY")
 {
  ...
  <p style="line-height:11px;font-weight:normal;"><b>'.$cashcno->branchaddr.'</b><br><b>'.$cashcno->branchcity.'</b><br><b>'.$cashcno->branchmobile.'</b>,<b>'.$cashcno->branchmail.'</b></p>
...
?>
          ...
          <div class="right">
               <div class="to-top">
               <div class="receiver-destn">From : <?=$stationcode?>-<?=$cashcno->br_code?></div>
               ...
               <?php
 $mode = $db->query("SELECT mode_name FROM mode where mode_code='$cashcno->mode_code'")->fetch(PDO::FETCH_OBJ);
              ...
              ?>
               ...
               &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Vehi No:&nbsp;</b> <?=$cashcno->Vehicle_no;?>
          ...
          <div class="right-corner">
                        ...
                        $igst_value = number_format((float)$cashcno->ramt - $calculated_value, 2, '.', '');
                         ...
                         <div class="charges" style="margin-top:5px;">
                              ...
                              <?php
                         if($challan_bottom[$i]!='PROOF OF DELIVERY'){
                          $width_amt  = (($cashcno->ramt >= 1000)? '110px;' : '90px;');
                              ...
                              echo "<p>SGST : <span class='amt_left'>".((empty($cashcno->gst) || substr($company->stn_gstin,0,2)==substr($cashcno->gst,0,2))?number_format((float)(($total_value)/2), 2, '.', ''):0.00)."</span></p>";
                              echo "<p>CGST : <span class='amt_left'>".((empty($cashcno->gst) || substr($company->stn_gstin,0,2)==substr($cashcno->gst,0,2))?number_format((float)(($total_value)/2), 2, '.', ''):0.00)."</span></p>";
                              echo "<p>IGST : <span  class='amt_left'>".((empty($cashcno->gst) || substr($company->stn_gstin,0,2)==substr($cashcno->gst,0,2))?0.00:number_format((float)(($igst_value)), 2, '.', ''))."</span></p>";
                              ...
                              echo "<p>Charges : NA</p>";
                              echo "<p>GST : NA</p>";
                              echo "<h2>Total : ".(($cashcno->zone_code >=100 && $cashcno->zone_code <=114)? number_format((float)$cashcno->ramt, 2, '.', '') : 'NA')."</h2>";
                         }
                         ?>
