...
function authorize($db,$user)
{
    ...
    $module = 'extcnotesalesrequestlist';
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <li class="list-inline-item active">
                                        ...
                                        <a href="<?php echo __ROOT__ . 'extcnotesalesrequestlist'; ?>">Cnote Sales list</a>
                                      </li>
                                    </ul>
                                </div>
                            </div>
      ...
      <div class="boxed boxBt panel panel-primary">
        <div class="title_1 title panel-heading">
              ...
              <div class="align-right" style="margin-top:-35px;">
                ...
                <a style="color:white" href="<?php echo __ROOT__ ?>cnotesalesrequest"><button type="button" class="btn btn-success btnattr" >
                      ...
                      $cnote_serial        = $_POST['cnote_serial']; 
                          ...
                          if(! empty($stationcode)) {
                           ...
                           if (count($conditions) > 0) {
                               $query = $db->query("SELECT * FROM cnotesalesrequest  WHERE  $conditons AND cust_code='$datafetch->cust_code'"); 
                           }
                           if (count($conditions) == 0) {
                             $query = $db->query("SELECT * FROM cnotesalesrequest $stn_condition AND cust_code='$datafetch->cust_code'  ORDER BY sales_req_id DESC"); 
                         }
                     }
                     //Normal Station list
                     else{
                         ...
                         while ($row = $query->fetch(PDO::FETCH_OBJ))
                          {
                            ...
                            echo "<td><div class='hidden-sm hidden-xs action-buttons'>
                                 ...
                                 <a class='btn btn-primary btn-minier' _href='cnotesalesdetail?soid=' data-rel='tooltip' title='Edit'>
                                  <i class='ace-icon fa fa-eye bigger-130'></i>
                                 </a>
                                 <a class='btn btn-success btn-minier' _href='sosummary?sonumber=' target='_blank'>
