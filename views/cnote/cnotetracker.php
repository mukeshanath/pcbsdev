        ...
        <div class="align-right" style="margin-top:-35px;">
               ...
               <table class="table" cellspacing="0" cellpadding="0" align="center">	
                ...
                <table class="table" cellspacing="0" cellpadding="0" align="center">	
                        ...
                        <td style="border-top:0px"><input id="trk_custcode" name="trk_custcode" type="text" value="" class="form-control input-sm" style="text-transform:uppercase;"></td>
                            
                        <td style="border-top:0px">Customer Name</td>
                        <td style="border-top:0px">
                            <input id="trk_custname" name="trk_custname" value="" class="form-control input-sm" type="text">
                        </td>
                        ...
                        <td style="border-top:0px">
                            <input id="trk_destname" name="trk_destname" value="" class="form-control input-sm stnname" type="text">
                        </td>
...
<script>
    ...
    $('#tracking_btn_bulk').click(function(){
        ...
        var trk_custcode = $('#trk_custcode').val();
