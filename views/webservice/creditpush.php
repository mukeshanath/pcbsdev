...
<html lang="en">
  <head>
    ...
    <body>
    <span>(c) Copyright: 2020-03-04 ... AS2 Web Service API......</span> <span style='font-weight:bold'>Credit push</span>
        <script>
   ...
   var datum= 
    <?php
          ...
          while($custrow = $customers->fetch(PDO::FETCH_OBJ)){
             $data = $db->query("SELECT * FROM credit WHERE date_added='$today_date' AND cust_code='$custrow->cust_code'");
                ...
                var count = Object.keys(datum).length;   
                    for(i=0;i<count;i++){  
                        ...
                        $.ajax({
                            ...
                            method:"POST",
                            data:{POD_NO:POD_NO1,WEIGHT:WEIGHT1,PIECES:PIECES1,AMOUNT:AMOUNT1,DESTINATION:DESTINATION1,ORIGIN:ORIGIN1},
                            dataType:"text",
                            async:false,  
