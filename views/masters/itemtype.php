            ...
            <input placeholder="" class="form-control border-form" name="user_name" type="text" id="user_name" value="<?php echo $_SESSION['user_name']; ?>" style="display:none;">    
              ...
              <div class="boxed boxBt panel panel-primary">
                <div class="title_1 title panel-heading">
                      <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Item Form</p>
        ...
        <div class="content panel-body">
          ...
          <div class="tab_form">
            ...
            <td>Company Code</td>
              ...
              <td>
                  <input class="form-control border-form" name="stnname" type="text" id="stnname" readonly>
                   ...
                   <tr>		
                    ...
                    <td>Item Code</td>
                    <td>
                    <input class="form-control border-form" name="item_code" type="text" id="item_code" autofocus>
               </td>
                <td>Item Name</td>
                  <td>
                     <input class="form-control border-form" name="item_name" type="text" id="item_name" >
               </td>	
               ...
               <tr>		
                 <td>Special Rate</td>
              <td>
                 <input class="form-control border-form" name="spl_rate" type="text" id="spl_rate">
                  </td>	

                  <td>Other Charges</td>
              <td>
                 <input class="form-control border-form" name="oth_chrg" type="text" id="oth_chrg">
                  </td>	
                   </tr>
             ...
             <button type="submit" class="btn btn-success btnattr_cmn" name="addanitem">
            <i class="fa  fa-save"></i>&nbsp; Save & Add
            </button>
            
            
            <button type="submit" class="btn btn-primary btnattr_cmn" name="additem">
