...
?>
  ...
  <div class="au-breadcrumb m-t-75" style="margin-bottom: -5px;">
          ...
          <div class="alert-primary" role="alert">
            ...
            <input class="form-control border-form" name="staff_id" type="text" id="staff_id" value="<?= $staff_id; ?>" style="display:none">
        ...
        <td>
        <div class="col-sm-9">
         <input class="form-control border-form "  name="exe_code" type="text" id="exe_code"  value="<?= $exe_code; ?>" >
         </div>
         </td>
        ...
        <td>People Name</td>
		  	<td>
            <div class="col-sm-9">
            <input class="form-control border-form "  name="exe_name" type="text" id="exe_name" value="<?= $exe_name; ?>" >
            </div>
        </td>	
    </tr>
    <tr>
    ...
    <td >
            <div class="col-sm-9">
                    <select class="form-control" name="people_type" value="<?= $people_type; ?>">
                    <option value="0">People Code</option>
         ...
         <tr>	
              ...
              <td >Address</td>
			      	<td>
                      <div class="col-sm-9"><input id="exe_add" class="form-control" name="exe_add"  type="text" value="<?= $exe_add; ?>" />
                      </div>
              </td>
              <td >City</td>
			      	<td>
                      <div class="col-sm-9"><input id="exe_city" name="exe_city" class="form-control"  type="text" value="<?= $exe_city; ?>"/>
                      </div>
              </td>
             ...
             <tr>	
              ...
              <td >State</td>
			      	<td>
                      <div class="col-sm-9"><input id="exe_state" name="exe_state" class="form-control"  type="text" value="<?= $exe_state; ?>"/>
                      </div>
              </td>
              <td>Country</td>
			      	<td>
                      <div class="col-sm-9"><input id="exe_country" name="exe_country" class="form-control" type="text" vvalue="<?= $exe_country; ?>"/>
                      </div>
              </td>
             ...
             <tr>
              ...
              <input id="exe_mobile" class="form-control" name="exe_mobile"  type="text" value="<?= $exe_mobile; ?>"/>
              </div>
              </td>

              <td >Email</td>
              <td>
              <div class="col-sm-9"><input id="exe_email" class="form-control" name="exe_email"  type="text" value="<?= $exe_email; ?>"/>
              </div>
              </td>
              </tr>
             <tr>
              <td >DOJ</td>
              <td>
              <div class="col-sm-9"><input id="exe_doj" class="form-control" name="exe_doj"  type="date" value="<?= $exe_doj; ?>"/>
              </div>
              </td>

              <td >Qualification</td>
              <td>
              <div class="col-sm-9"><input id="exe_qualification" class="form-control" name="exe_qualification"  type="text" value="<?= $exe_qualification; ?>"/>
              </div>
              </td>
              ...
              <td class="">Remarks</td>
              <td>
              <div class="col-sm-9"><input id="remarks" class="form-control" name="remarks"  type="text" value="<?= $exe_remarks; ?>"/></div></td>
              <td class="">Active</td>
              <td>
              <div class="col-sm-9">
              <select class="form-control border-form" name="active" id="active" value="<?= $exe_status; ?>">
