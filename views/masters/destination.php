  ...
  <div class="au-breadcrumb m-t-75" style="margin-bottom: -5px;">
       ...
       <div class="alert-primary" role="alert">
        ...
        <div class="content panel-body">
          ...
          <div class="tab_form">
           ...
           <td>Destination Code</td>
                <td style="width:30%"><div class="autocomplete col-sm-7 ">
                 ...
                 <input  class="form-control border-form" name="dest_code" type="text" id="dest_code" autofocus>
                ...
                <div class="autocomplete col-sm-7">
                 <input  class="form-control border-form" name="dest_name" type="text" id="dest_name" >
                </div>           
                </td>
               ...
               <td>State Code</td>
                <td style="width:30%"><div class="autocomplete col-sm-7">
                 ...
                 <input  class="form-control border-form" name="state" type="text" id="state" readonly>
                 </div>      
                </td>
                ...
                <td >
                <div class="col-sm-7">
                 <input  class="form-control border-form" name="stname" type="text" id="stname" readonly>
                      </div>        
                </td>
                </tr>
                  <tr>
                  <td>Zone A</td>
                    ...
                    <div class="col-sm-11">
                    <input  class="form-control border-form" name="zonecode_a" type="text" id="zonecode_a"></div>
                    <div class="col-sm-1">
                    ...
                    <td><div class=" autocomplete col-sm-7">
                    <div class="col-sm-11">
                    <input  class="form-control border-form" name="zonecode_b" type="text" id="zonecode_b"></div>
                    <div class="col-sm-1">
                  ...
                  <td>Zone C</td>
                    <td><div class=" autocomplete col-sm-7">
                    <div class="col-sm-11">
                    <input  class="form-control border-form" name="zonecode_c" type="text" id="zonecode_c"></div>
                    <div class="col-sm-1">
                    ...
                    <div class="autocomplete col-sm-7">
                    <div class="col-sm-11">
                    <input  class="form-control border-form" name="zone_cash" type="text" id="zone_cash"></div>
                    <div class="col-sm-1">
            ...
            <div class="autocomplete col-sm-7">
            <div class="col-sm-11">
             <input  class="form-control border-form" name="zone_ts" type="text" id="zone_ts"></div>
             <div class="col-sm-1">
            ...
            <td>
            <div class="autocomplete col-sm-7">
            <input  class="form-control border-form" name="hub1" type="text" id="hub1">
            ...
            <td>
            <div class="autocomplete col-sm-7">
             <input  class="form-control border-form" name="hub2" type="text" id="hub2">
          ...
          <button type="submit" class="btn btn-success btnattr_cmn" name="addandestination">
...
<div class="modal fade" id="zcash" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="width:30%">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <?php
       $model_cash=$db->query("SELECT * FROM zone WHERE comp_code='$stncodesrow' AND zone_type='cash'");
