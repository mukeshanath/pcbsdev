...
if (isset($_GET['brcid'])) {
$brcid_id = $_GET['brcid'];
$sql = $db->query("SELECT * FROM brcategorytb WHERE brcid = '$brcid_id'");
$row = $sql->fetch();
$brcid         = $row['brcid'];
$brcate_code   = $row['brcate_code'];
$brcate_name   = $row['brcate_name'];
...
<div class="container">
  ...
  <section class="au-breadcrumb m-t-75" style="margin-bottom: -20px;">
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Branch Category Edit</li>
                                        </ul>
                                    </div>
            ...
            <form method="POST" action="<?php echo __ROOT__ ?>bredit" accept-charset="UTF-8" class="form-horizontal" id="formbrcategory" enctype="multipart/form-data">

                <h4 class="header large lighter blue"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Branch Category form</h4>
                 <input  class="form-control border-form" name="brcid" type="text" id="brcid" value="<?= $brcid; ?>" hidden>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-1">
                    <input placeholder="" value="<?= $brcate_code; ?>" class="form-control border-form" name="brcate_code" type="text" id="brcate_code"  autofocus>
                </div>

                <label for="brcate_name" class="col-sm-1 control-label">Category name</label>
                <div class="col-sm-2">
                    <input  value="<?= $brcate_name; ?>" class="form-control border-form" name="brcate_name" type="text" id="brcate_name" >
                </div>
          ...
          <div class="card-body" style="margin-left: 450px;">
            ...
            <button type="submit" class="btn btn-primary" name="updatebrcategory">
