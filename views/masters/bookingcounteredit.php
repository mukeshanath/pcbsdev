...
function loadaddresstype($db)
    ...
    function countercode($db,$user)
    {
        ...
        $book_code=$db->query("SELECT TOP 1 book_code FROM bcounter WHERE stncode='$station_code' ORDER BY bkcid DESC");
        if($book_code->rowCount()== 0)
            {
            $bookingcode = $station_code.'BC10001';
            }
        else{
...
<form method="POST" autocomplete="off" action="<?php echo __ROOT__ ?>bookingcounteredit" accept-charset="UTF-8" class="form-horizontal" id="formcompany" enctype="multipart/form-data">
 ...
 <div class="boxed boxBt panel panel-primary">
   ...
   <div class="tab_form" >
    <div class="tab-content">
     ...
     <table id="formPOSpurchase" cellpadding="0" border="0" cellspacing="0" align="center" class="table">
      ...
      <tr>		
            ...
            <td >
                <div class="col-sm-9 autocomplete">
                <input class="form-control border-form" value="<?= $book_code; ?>" name="book_code" value="<?php echo countercode($db,$user); ?>" type="text" id="book_code" readonly>
                </div>
            </td>
            ...
            <td>
                <div class="col-md-9">
                <input class="form-control border-form " value="<?= $book_name; ?>" name="book_name" type="text" id="book_name"  >       
                </div>
            </td>
       </tr>
      <tr>				
			  ...
			  <td>
               <div class="col-sm-9">
                    <input class="form-control border-form" value="<?= $book_addr; ?>"  name="book_addr" type="text" id="book_addr"  >
             ...
             <td>City</td>
			  <td>
               <div class="col-sm-9">
                    <input class="form-control border-form" value="<?= $book_city; ?>" name="book_city" type="text" id="book_city">
                </div>
             </td>
                </tr>
    <tr>
    <tr>			
			  ...
			  <td>
               <div class="col-sm-9">
                    <input class="form-control border-form" value="<?= $book_state; ?>" name="book_state" type="text" id="book_state">
             ...
             <td>Country</td>
			  <td>
               <div class="col-sm-9">
                    <input class="form-control border-form" value="<?= $book_country; ?>" name="book_country" type="text" id="book_country">
    ...
    <tr>
        <td>Phone</td>
			  <td>
              <div class="col-sm-9">
                    <input  class="form-control border-form" value="<?= $book_phone; ?>" name="book_phone" type="text" id="book_phone">
        ...
        <td>Fax</td>
		  	<td>
            <div class="col-sm-9">
                 <input  class="form-control border-form" value="<?= $book_fax; ?>" name="book_fax" type="text" id="book_fax"  >
    ...
    <tr>	
		  	...
		  	<td>
             <div class="col-sm-9">
                  <input  class="form-control border-form" value="<?= $book_email; ?>" onfocusout="email_val(this)" name="book_email" type="text" id="book_email" placeholder="" >
    ...
    <tr>	
        ...
        <td>Active</td>
         ...
         <td>Remarks</td>
		  	<td>
            <div class="col-sm-9">
            <input  class="form-control border-form" rows="1" value="<?= $book_remarks; ?>" name="book_remarks" cols="50" id="book_remarks">     
            </div>  
        </td>
 ...
 <div id="regulatory" class="tab-pane" style="margin-left: 25px;">
    <table id="formPOSpurchase" cellpadding="0" border="0" cellspacing="0" align="center" class="table">
        <tbody>
          ...
          <td>
              <div class="col-sm-9">
                <input class="form-control border-form" value="<?= $book_gstin; ?>" onfocusout="gst_val(this)"  name="book_gstin" type="text" id="book_gstin" >	
          ...
          <td>
              <div class="col-sm-9">
              <input class="form-control border-form " value="<?= $book_tin; ?>" name="book_tin" type="text" id="book_tin" >
              </div> 
          </td>	
          ...
          <td>
              <div class="col-sm-9">
              <input  class="form-control border-form" value="<?= $book_fsc; ?>" name="book_fsc" type="text" id="book_fsc"  >
              </div> 
          </td>	
          ...
          <td>
              <div class="col-sm-9">
              <input  class="form-control border-form" value="<?= $book_deposit; ?>" name="book_deposit" type="text" id="book_deposit"  >
              </div>
          </td>	
          <td>C-Note Charge</td>
          <td>
