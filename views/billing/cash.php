...
// changes by zabi
 ...
 // changes by zabi
  ...
  $cc_total_amount = $db->query("SELECT SUM(ramt) AS amount FROM cash WHERE comp_code='$stationcode' AND br_code='$brcode' AND cc_code='$collcentr_code' AND tdate='$getgst->tdate' AND cc_status is NULL AND ccinvno is NULL");
       ...
       <div class="alert-primary" role="alert">
        ...
        <div class="boxed boxBt panel panel-primary">
          <div class="title_1 title panel-heading">
                <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Cash Entry Form</p>
        ...
        <div class="content panel-body">
          ...
          <div class="tab_form">
           ...
           <tr>		
            ...
            <td>
                <div class="col-sm-12">
                    <input class="form-control border-form text-uppercase" tabindex="-1" name="br_name" type="text" id="br_name" <?=(!empty($sessionbr_code)?" readonly":"")?> value="<?=$brname;?>">
                     <p id="stnname_empty" class="form_valid_strings">Field Cannot be Empty.</p>
                </div>
            </td>
       </tr>
        ...
        <td>
        <div class="col-sm-12">
            <input type="text" id="cc_name" name="cc_name" tabindex="-1" class="form-control text-uppercase" <?=(!empty($user_cc)?" readonly value='$user_ccname'":" value='$collcentr_name' ")?>>
            </div>
        </td>
        ...
        <td>
        <div class="col-sm-12">
            <input type="text" id="book_counter_name" tabindex="-1" name="book_counter_name" class="form-control text-uppercase" value="<?=(isset($bookcounter)?$bookcountername:'')?>">
            </div>
        </td>
        ...
        <td>
            <div class="col-sm-9">
                <select id="cnote_type" tabindex="-1" name="cnote_type" class="form-control" onchange="verifyvirtual(this);verify_bacnoteverify();$('#cnote_no').val('')">
        ...
        <td>
        <div class="col-sm-12">
            <input type="text" id="payment_reference" tabindex="-1" name="payment_reference" class="form-control text-uppercase">
            </div>
        </td>
      <td>GST</td>
        <td>
            <div class="col-sm-12">
            <input type="text" id="gstin" value="<?=(($_GET['ch_shipper']==1)? $getgst->gst : '')?>" name="gstin" class="form-control text-uppercase" tabindex="-1" onfocusout="(($(this).val().trim().length>0)?gst_val(this):$('#gst_val').css('display','none'))">
        ...
        <tr>
          ...
          <input type="text" tabindex="-1" id="contents" name="contents" class="form-control text-uppercase">  
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <td>
                                        <input type="text" <?=((empty($cnote_type))? 'readonly' :(($cnote_type=='Virtual')? 'readonly' : ''));?> id="cnote_no" name="cnote_no" tabindex="-1" class="form-control" onfocusout="cashcnotevalidation();getcashcnotedetail()" value="<?=$cnote_number;?>" onkeyup="validatebranch(this.value)">
                                            <p id="cnote_no_validation" class="form_valid_strings">Please enter Cnote No.</p>
                                            <p id="cnote_no_invalid" class="form_valid_strings">Cnote No Invalid.</p></td>
                                        <!-- <td>
                                        <input id="con_address" name="con_address" value="" class="form-control" type="text"></td>
                                        <td>
                                        <input id="con_mobile" name="con_mobile" value="" class="form-control" type="text">
                                        </td> -->
                                        ...
                                        <td>
                                            <input name="wt" id="wt" class="form-control "  aria-invalid="false" type="text" value="0" onfocusout="calculateamount()">
                                        ...
                                        <td>
                                            <input type="number" name="pcs" class="form-control" tabindex="-1" id="pcs" value="1"  onfocusout="calculateamount()">
            ...
            <div class="col-sm-12">
                <div class="col-sm-12" style="padding-right:10px">
                   <table class="table table-bordered table-hover">
                    ...
                    <input type="checkbox" <?=(($ch_shipper==1)? 'checked' : '')?>  aria-label="..." value='1' id="check1" name="check_shipper">
                    </span>
                    <input type="text" oninput="this.value =!!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" class="form-control box" placeholder="Shipper Mobile" name="shp_mob" id="shp_mob">
                    </div></td><td style="width:20%"><input type="text" class="form-control text-uppercase" placeholder="Shipper Name"  name="shp_name" id="shp_name"></td>
                    <td><input type="text" class="form-control text-uppercase" placeholder="Shipper Address" name="shp_addr" id="shp_addr"></td>
                    <td style="width:20%"><input type="number" class="form-control" placeholder="Shipper Pincode" name="shp_pin" id="shp_pin"></td>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <input type="checkbox"  aria-label="..." <?=(($ch_shipper2==1)? 'checked' : '')?> value='1' name="check_shipper2">
                    </span>
                    <input type="number" <?=(($cnote_type=='Virtual')?' required ':' ')?> class="form-control" placeholder="Consignee Mobile" maxlength="10" name="consignee_mob" id="consignee_mob"></div>
				</td> <td style="width:20%"><input type="text" class="form-control text-uppercase" placeholder="Consignee" name="consignee_name" id="consignee_name"></td>
                         <td><input type="text" class="form-control text-uppercase" placeholder="Consignee Address" name="consignee_addr" id="consignee_addr"></td>
                         <td style="width:20%"><input type="number" class="form-control" placeholder="Consignee Pincode" name="consignee_pin" id="consignee_pin"></td>
                    </tr>
                </table>
                </div>
        </div>
...
<script>
 ...
 var checked = '<?= $ch_shipper ?>';
 if(checked==1){
    $('#shp_name').val('<?= $sh_name ?>');
    $('#shp_mob').val('<?= $sh_mob ?>');
    $('#shp_addr').val('<?= $sh_addr ?>');
    $('#shp_pin').val('<?= $sh_pin ?>');
 }else{
    $('#shp_name').val('');
    $('#shp_mob').val('');
 ...
 var checked2 = '<?= $ch_shipper2 ?>';
 if(checked2==1){
    $('#consignee_name').val('<?= $c_name ?>');
    $('#consignee_mob').val('<?= $c_mob ?>');
    $('#consignee_addr').val('<?= $c_addr ?>');
    $('#consignee_pin').val('<?= $c_pin ?>');
 }else{
    $('#consignee_name').val('');
    $('#consignee_mob').val('');
    $('#consignee_addr').val('');
...
<script>
        ...
        $.ajax({
                ...
                method:"POST",
                async: false,
                data:{bk_date,br_code,stncode,cc_code,action : 'cc_total_amount'},
                dataType:"text",
      ...
      $.grep(filesAry, function(el) { 
       if ($.inArray(el, newDelFilesAry) == -1) arr.push(el);
            ...
            $.ajax({
                url:"<?php echo __ROOT__ ?>billingcontroller",
                method:"POST",
                data:{dest_mode:destcode2,mode_origin:mode_origin,mode_cust:mode_cust,arr:arr,table:table,podorigin:podorigin,branch:branch},
                dataType:"text",
...
<script>
    ...
    $.ajax({
            url:"<?php echo __ROOT__ ?>billingcontroller",
            method:"POST",
            data:{customer:customer,origin:origin,destination:destination,weight:weight,pcs:pcs,mode:mode,pod_amt:pod_amt,branch:branch},
            dataType:"text",
...
<script>
    ...
    // window.history.pushState('Credit', 'Title', '/cash');

    </script>
<script>
    $(window).on('load', function() {
        if('<?=$_GET['cno']?>'.trim().length>0){
            window.open('labelbarcode?cno=<?=$_GET['cno']?>&pcs=<?=$_GET['pieces']?>&wt=<?=$_GET['wt']?>&cc=<?=$_GET['cc']?>&destcode=<?=$_GET['destcode']?>&podorigin=<?=$_GET['podorigin']?>'); 
        }
    })   
