...
<div id="col-form1" class="col_form lngPage col-sm-25">
            ...
            <div class="boxed boxBt panel panel-primary">
                  <div class="title_1 title panel-heading">
                    <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Rate Deviation Check Form</p>
          ...
          <table class="table" cellspacing="0" cellpadding="0" align="center">	
            <tbody>
              <tr>		
                  ...
                  <td>
                  <div class="col-sm-9">
                        <input class="form-control border-form" name="rate_excel" type="file" id="rate_excel"  accept=".xlsx,.csv" onchange="ValidateSingleInput(this)">
                   </div>
                     </td>                 
                  </tr>	
                    </tbody>
                  ...
                  <div class="align-right btnstyle" >
		              ...
		              <button type="submit" class="btn btn-success btnattr_cmn" name="saveall">
