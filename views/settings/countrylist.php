...
<div class="au-breadcrumb m-t-75" style="margin-bottom: -5px;">
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <li class="list-inline-item active">
                                        ...
                                        <a href="<?php echo __ROOT__ . 'countrylist'; ?>">Country list</a>
                                      </li>
                                    </ul>
                                </div>
        ...
        <div class="alert-primary" role="alert">
             ...
             <form method="POST"  accept-charset="UTF-8" class="form-horizontal" id="formstate" enctype="multipart/form-data">
      ...
      <div class="boxed boxBt panel panel-primary">
        <div class="title_1 title panel-heading">
              <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Country Filters</p>
              <div class="align-right" style="margin-top:-35px;">

            <a style="color:white" href="<?php echo __ROOT__ ?>country" ><button type="button" class="btn btn-success btnattr" >
          ...
          <table class="table" cellspacing="0" cellpadding="0" align="center">	
            <tbody>
              <tr>		
                  ...
                  <td>
                  <div class="col-sm-9">
                    <input class="form-control border-form" name="coun_code" value="<?php if(isset($_POST['coun_code'])){ echo  $_POST['coun_code']; } ?>" type="text" id="coun_name" autofocus>  
                   </div>
                   </td>
                  ...
                  <td>
                  <div class="col-sm-9">
                       <input class="form-control border-form" name="coun_name" type="text" id="coun_name" value="<?php if(isset($_POST['coun_name'])){ echo  $_POST['coun_name']; } ?>">
                    </div>
                      </td>
                  ...
                  <table>
                    ...
                    <button class="btn btn-info btnattr_cmn" type="submit" id="filter-btn" name="filtercountry">
...
<!-- Fetching Mode Details in Table  -->
        <div class="col-sm-12 data-table-div" >
         ...
         <div class="title_1 title panel-heading">
              <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Country List</p>
         ...
         <thead><tr>
            <th class="center">
              ...
              <?php 
                  ...
                  $query = $db->query('SELECT * FROM country ORDER BY coun_id DESC');
                  while ($row = $query->fetch(PDO::FETCH_OBJ))
                  {
                    ...
                    // echo "<td>".$row->stid."</td>";
                    echo "<td>".$row->coun_code."</td>";
                    echo "<td>".$row->coun_name."</td>";
                    echo "<td><div class='hidden-sm hidden-xs action-buttons'>
                        <a class='btn btn-success btn-minier' href='countryedit?coun_id=".$row->coun_id."'>
                          <i class='ace-icon fa fa-pencil bigger-130'></i>
                        </a>

                          <a  class='btn btn-danger btn-minier bootbox-confirm' id='country,$row->coun_id,coun_id' onclick='".delete($db,$user)."'>
   ...
   var usr_name = $('#user_name').val();    
        $.ajax({
            ...
            if($('#stncode').val() == '')
              {
                //alert(data[0]);
                $('#countryadd').attr('href','<?php echo __ROOT__ ?>country');
              }
              else {
                $("#countryadd").click(function() {
                  alert("You do not have permission to add country.");
                  });
              }
            }
    });
