...
<div class="au-breadcrumb m-t-75" style="margin-bottom: -5px;">
      ...
      <div class="boxed boxBt panel panel-primary">
        <div class="title_1 title panel-heading">
              <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">State Filters</p>
              <div class="align-right" style="margin-top:-35px;">

            <a style="color:white"  href="<?php echo __ROOT__ ?>state" ><button type="button" class="btn btn-success btnattr" >
          ...
          <table class="table" cellspacing="0" cellpadding="0" align="center">	
            <tbody>
              <tr>		
                  ...
                  <td>
                  <div class="col-sm-9">
                    <input class="form-control border-form" name="statecode" type="text" id="statecode" value="<?php if(isset($_POST['statecode'])){ echo  $_POST['statecode']; } ?>" autofocus>  
                   </div>
                     </td>
                  ...
                  <td>
                  <div class="col-sm-9">
                       <input class="form-control border-form" name="state_name" type="text" id="state_name" value="<?php if(isset($_POST['state_name'])){ echo  $_POST['state_name']; } ?>">
                    </div>
                      </td>
                  ...
                  <table>
                    ...
                    <button class="btn btn-info btnattr_cmn" type="submit" id="filter-btn" name="filterstate">
...
<!-- Fetching Mode Details in Table  -->
        <div class="col-sm-12 data-table-div" >
         ...
         <div class="title_1 title panel-heading">
              <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">State List</p>
              ...
              <?php 
                  ...
                  while ($row = $query->fetch(PDO::FETCH_OBJ))
                  {
                    ...
                    echo "<td><div class='hidden-sm hidden-xs action-buttons'>
                        <a class='btn btn-success btn-minier' href='stateedit?stid=".$row->stid."'>
                          <i class='ace-icon fa fa-pencil bigger-130'></i>
                        </a>

                          <a  class='btn btn-danger btn-minier bootbox-confirm' id='state,$row->stid,stid' onclick='".delete($db,$user)."'>
   ...
   var usr_name = $('#user_name').val();    
        $.ajax({
            ...
            if($('#stncode').val() == '')
              {
                //alert(data[0]);
                $('#stateadd').attr('href','<?php echo __ROOT__ ?>state');
              }
              else {
                $("#stateadd").click(function() {
                  alert("You do not have permission to add state.");
                  });
              }
            }
    });
