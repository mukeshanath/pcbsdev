...
<div class="au-breadcrumb m-t-75" style="margin-bottom: -5px;">
         ...
         <div class="alert-primary" role="alert">
            ...
            <form method="POST"  accept-charset="UTF-8" class="form-horizontal" id="formrefer" enctype="multipart/form-data">
            ...
            <div class="boxed boxBt panel panel-primary">
              <div class="title_1 title panel-heading">
                    <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Reference Filters</p>
                    <div class="align-right" style="margin-top:-35px;">

                    <a style="color:white" href="<?php echo __ROOT__ ?>reference" ><button type="button" class="btn btn-success btnattr" >
      ...
      <div class="content panel-body">
          ...
          <table class="table" cellspacing="0" cellpadding="0" align="center">	
            <tbody>
              <tr>		
                  ...
                  <td>
                  <div class="col-sm-9">
                       <input placeholder="" class="form-control border-form" name="ref_code" type="text" id="ref_code" value="<?php if(isset($_POST['ref_code'])){ echo  $_POST['ref_code']; } ?>" autofocus>
                   </div>
                     </td>
                  ...
                  <td>
                  <div class="col-sm-9">
                       <input placeholder="" class="form-control border-form" name="ref_type" type="text" id="ref_type" value="<?php if(isset($_POST['ref_type'])){ echo  $_POST['ref_type']; } ?>" >
                    </div>
                      </td>
                  ...
                  <table>
                    ...
                    <button class="btn btn-info btnattr_cmn" type="submit" id="filter-btn" name="filterreference">
        ...
        Reset <i class="fa fa-refresh bigger-110"></i>                         
                ...
                <div class="col-sm-12 data-table-div" >
                 ...
                 <div class="title_1 title panel-heading">
              <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Reference List</p>
                 ...
                 <thead><tr>
                    <th class="center">
                      ...
                      <?php 
                         ...
                         $query = $db->query('SELECT * FROM reference ORDER BY rid DESC');
                         while ($row = $query->fetch(PDO::FETCH_OBJ))
                          {
                            ...
                            echo "<td><div class='hidden-sm hidden-xs action-buttons'>
                                 <a class='btn btn-success btn-minier' href='referenceedit?rid=".$row->rid."'>
                                  <i class='ace-icon fa fa-pencil bigger-130'></i>
                                 </a>

                                 <a  class='btn btn-danger btn-minier bootbox-confirm' id='reference,$row->rid,rid' onclick='".delete($db,$user)."'>
   ...
   var usr_name = $('#user_name').val();    
        $.ajax({
            ...
            if($('#stncode').val() == '')
              {
                //alert(data[0]);
                $('#referenceadd').attr('href','<?php echo __ROOT__ ?>reference');
              }
              else {
                $("#referenceadd").click(function() {
                  alert("You do not have permission to add reference.");
                  });
              }
            }
    });
