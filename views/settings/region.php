	     ...
	     if ( isset($_GET['unsuccess']) && $_GET['unsuccess'] == 4 )
            ...
            <div class="boxed boxBt panel panel-primary">
              <div class="title_1 title panel-heading">
                    <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Region Form</p>
           ...
           <table class="table" cellspacing="0" cellpadding="0" align="center">	
            <tbody>
              <tr>		
                  ...
                  <td>
                  <div class="col-sm-9">
                        <input placeholder=""  class="form-control border-form" name="regioncode" type="text" id="regioncode"  autofocus>
                   </div>
                     </td>
                  ...
                  <td>
                  <div class="col-sm-9">
                         <input placeholder="" class="form-control border-form" name="regionname" type="text" id="regionname" >
                    </div>
                      </td>
                  ...
                  <td>
                      <div class="col-sm-12">
                        <select class="form-control container-fluid"  name="statenames[]" id="statenames" multiple>
                        <?php echo loadstate($db); ?>
                        </select>
                      </div>
                  </td>
                  <td>Active</td>		
                  ...
                  <button type="submit" class="btn btn-success btnattr_cmn" name="addanregion">
                  <i class="fa  fa-save"></i>&nbsp; Save & Add
                  </button>

                  <button type="submit" class="btn btn-primary btnattr_cmn" name="addregion">
