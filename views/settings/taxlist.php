...
<div class="au-breadcrumb m-t-75" style="margin-bottom: -5px;">
        ...
        <div class="alert-primary" role="alert">
          ...
          <form method="POST" action="<?php echo __ROOT__ ?>tax" accept-charset="UTF-8" class="form-horizontal" id="formtax" enctype="multipart/form-data">
      ...
      <div class="boxed boxBt panel panel-primary">
        <div class="title_1 title panel-heading">
              <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Tax Filters</p>
              <div class="align-right" style="margin-top:-35px;">

                    <a style="color:white" href="<?php echo __ROOT__ ?>tax" ><button type="button" class="btn btn-success btnattr" >
          ...
          <table class="table" cellspacing="0" cellpadding="0" align="center">	
            <tbody>
              <tr>		
                  <td>Tax Code</td>
                  <td>
                       <input placeholder="" class="form-control border-form" name="taxcode" type="text" id="taxcode" value="<?php if(isset($_POST['taxcode'])){ echo  $_POST['taxcode']; } ?>" autofocus>
                  </td>
                    
                  <td class="">Tax Value</td>
                  <td>
                       <input placeholder="" class="form-control border-form" name="taxval" type="text" id="taxval" value="<?php if(isset($_POST['taxval'])){ echo  $_POST['taxval']; } ?>">
                  </td>
                  <td class="">Active</td>
                  <td>
                  ...
                  <table>
                    ...
                    <button class="btn btn-info btnattr_cmn" type="submit" id="filter-btn" name="filtertax">
...
<!-- Fetching Tax Details in Table  -->
        <div class="col-sm-12 data-table-div" >
           <div class="title_1 title panel-heading">
              <p style="font-weight:600;font-size:20px;color:white;margin-top:6px;">Tax % List</p>
         ...
         <thead><tr>
            <th class="center">
              ...
              <?php 
                    ...
                    $query = $db->query('SELECT * FROM tax ORDER BY taxid DESC');
                         while ($row = $query->fetch(PDO::FETCH_OBJ))
                          {
                            ...
                            echo "<td>".$row->taxval."</td>";
                            echo "<td><div class='hidden-sm hidden-xs action-buttons'>
                               <a class='btn btn-success btn-minier' href='taxedit?taxid=".$row->taxid."'>
                                  <i class='ace-icon fa fa-pencil bigger-130'></i>
                                 </a>

                                 <a  class='btn btn-danger btn-minier bootbox-confirm' id='tax,$row->taxid,taxid' onclick='".delete($db,$user)."'>
   ...
   var usr_name = $('#user_name').val();    
        $.ajax({
            ...
            if($('#stncode').val() == '')
              {
                //alert(data[0]);
                $('#taxadd').attr('href','<?php echo __ROOT__ ?>tax');
              }
              else {
                $("#taxadd").click(function() {
                  alert("You do not have permission to add tax.");
                  });
              }
            }
    });
